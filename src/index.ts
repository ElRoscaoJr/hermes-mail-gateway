...
export type { ImapAdapter, SmtpAdapter, SmtpEnvelope, SmtpOutcome, NodemailerSmtpOptions, MailFolder, MailSummary, MailMessage, MailAttachment, ImapFlowClient, ImapFlowClientFactory, ImapFlowMailAdapterOptions } from "./mail/adapters.js";
