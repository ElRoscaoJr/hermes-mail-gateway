...
export interface PreparedMessage { messageId: string; accountId: string; idempotencyKey: string; messageIdHeader: string; intent?: "send" | "draft"; fromAddress: string; recipients: readonly string[]; cc: readonly string[]; bcc: readonly string[]; replyTo?: string; inReplyTo?: string; references: readonly string[]; forwarding?: ForwardingMetadata; subject: string; textBody?: string; htmlBody?: string; attachments: readonly AttachmentManifest[]; state: OutboxState; }
