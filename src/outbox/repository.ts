...
export interface PrepareInput { accountId: string; idempotencyKey: string; fromAddress: string; recipients: readonly string[]; cc?: readonly string[]; bcc?: readonly string[]; replyTo?: string; inReplyTo?: string; references?: readonly string[]; forwarding?: { originalMessageReference: string; originalMessageId?: string; originalSubject?: string }; subject: string; textBody?: string; htmlBody?: string; attachments: readonly unknown[]; rawMime: Buffer; requestDigest: string; messageId: string; messageIdHeader: string; audit?: { correlationId: string; caller: string; tool: string; metadata: unknown }; }
