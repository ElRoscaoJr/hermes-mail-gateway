...
- [x] SQLite migration 2 adds nullable SMTP credential storage exactly once for fresh and legacy databases; repository upsert/get round-trips distinct references and preserves fallback behavior.
